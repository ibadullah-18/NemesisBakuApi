        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoyaltyCardCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryTimeRange = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PromoDiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    IsWhatsappMessageSent = table.Column<bool>(type: "bit", nullable: false),
                    WhatsappMessageSentAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WhatsAppClickLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WhatsAppClickLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WhatsAppClickLogs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WhatsAppProductInquiries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WhatsAppProductInquiries_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketItems_UserId_ProductVariantId",
                table: "BasketItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WhatsAppClickLogs_ProductId",
                table: "WhatsAppClickLogs",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_WhatsAppClickLogs_UserId",
                table: "WhatsAppClickLogs",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WhatsAppProductInquiries_UserId",
                table: "WhatsAppProductInquiries",
                column: "UserId");
        }
